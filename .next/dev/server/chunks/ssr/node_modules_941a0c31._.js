...
"[project]/node_modules/async-lock/lib/index.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/async-lock/index.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

module.exports = __turbopack_context__.r("[project]/node_modules/async-lock/lib/index.js [app-rsc] (ecmascript)");
}),
"[project]/node_modules/tinacms/dist/client.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var init_node_cache = __esm({
    "src/cache/node-cache.ts" () {
        ...
        makeCacheDir = (dir, fsArg, pathArg, osArg)=>{
            ...
            try {
                fsArg.mkdirSync(cacheDir, {
                    recursive: true
                });
            } catch (error) {
                console.warn(`Warning: Failed to create cache directory: ${error.message}. Caching will be disabled.`);
                return null;
            }
            return cacheDir;
        };
        NodeCache = async (dir)=>{
            try {
                const [fsModule, pathModule, osModule, cryptoModule] = await Promise.all([
                    __turbopack_context__.A("[externals]/node:fs [external] (node:fs, cjs, async loader)"),
                    __turbopack_context__.A("[externals]/node:path [external] (node:path, cjs, async loader)"),
                    __turbopack_context__.A("[externals]/node:os [external] (node:os, cjs, async loader)"),
                    __turbopack_context__.A("[externals]/node:crypto [external] (node:crypto, cjs, async loader)")
                ]);
                ...
                if (typeof path?.join !== "function") {
                    console.warn("Warning: Node.js path module not available. Caching will be disabled.");
                    return null;
                }
                ...
                return {
                    ...
                    get: async (key)=>{
                        ...
                        try {
                            ...
                            if (e.code !== "ENOENT") {
                                console.warn(`Warning: Failed to read cache file ${cacheFilename}: ${e.message}`);
                            }
                        }
                        return readValue;
                    },
                    set: async (key, value)=>{
                        ...
                        try {
                            ...
                            if (e.code !== "EEXIST") {
                                console.warn(`Warning: Failed to write cache file ${cacheFilename}: ${e.message}`);
                            }
                        }
                    }
                };
            } catch (e) {
                console.warn("Warning: Failed to initialize cache. Caching will be disabled.", e.message);
                return null;
            }
        };
    }
...
var TinaClient = class {
    ...
    async init() {
        ...
        try {
            if (this.cacheDir && ("TURBOPACK compile-time value", "undefined") === "undefined") {
...
async function requestFromServer(url, query, optionsObject, errorPolicyDefined) {
    ...
    if (!res.ok) {
        ...
        throw new Error(`Server responded with status code ${res.status}, ${res.statusText}. ${additionalInfo ? additionalInfo : ""} Please see our FAQ for more information: https://tina.io/docs/r/FAQ/`);
    }
    const json = await res.json();
    if (json.errors && errorPolicyDefined === "throw") {
        throw new Error(`Unable to fetch, please see our FAQ for more information: https://tina.io/docs/r/FAQ/
      Errors: 
...
//# sourceMappingURL=node_modules_941a0c31._.js.map